...
def create_app():
    ...
    from routes.auth import google_login, facebook_login
    ...
    with app.app_context():
        try:
            ...
            from models import SubscriptionPlan, UserSubscription, Payment, TeacherProfile
            ...
            print(f"Note: Database initialization deferred: {e}")
